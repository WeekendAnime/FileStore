...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7497710684:AAHPKfWTzYxLj60YEwe_oALxzOqX3KWiriM")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002495531414"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "Cluser2")
...
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002006075403"))
FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", "-1002172787340"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6266529037 6429532957").split()):
        ADMINS.append(int(x))
except ValueError:
